...
// --- CONTEÚDO DIÁRIO (Com links diretos de vídeo ultra-estáveis) ---
const conteudoDiario = {
    9: {
        ...
        video: "https://media4.giphy.com/media/L0SaP0Avd0q5ZjjNcu/giphy.mp4",
        sondagem: {
    ...
    8: {
        ...
        video: "https://media3.giphy.com/media/26AHONQ79FdWZhAI0/giphy.mp4",
        sondagem: {
    ...
    7: {
        ...
        video: "https://media1.giphy.com/media/ZqlvCTNHpqri0/giphy.mp4",
        sondagem: {
    ...
    6: {
        ...
        video: "https://media2.giphy.com/media/3o7TKRBB3E7I5NLmAU/giphy.mp4",
        sondagem: {
    ...
    5: {
        ...
        video: "https://media4.giphy.com/media/xT5LMGfRsLUsmNDYY8/giphy.mp4",
        sondagem: {
    ...
    4: {
        ...
        video: "https://media3.giphy.com/media/w7mLEAMcpjrpe/giphy.mp4",
        sondagem: {
    ...
    3: {
        ...
        video: "https://media0.giphy.com/media/YoWOIjn7YJkibTUrHk/giphy.mp4",
        sondagem: {
    ...
    2: {
        ...
        video: "https://media1.giphy.com/media/Lopx9n734rb0CLfXy7/giphy.mp4",
        sondagem: {
    ...
    1: {
        ...
        video: "https://media2.giphy.com/media/artj92V8o75VPL7AeQ/giphy.mp4",
        sondagem: {
    ...
    try {
        ...
        if (diffDias > 0) {
            if (conteudoDiario[diffDias]) {
                ...
                console.log(`A descarregar o GIF/Vídeo para o dia ${diffDias}...`);
                const bufferVideo = await baixarBuffer(diaAtual.video);

                // Envia como vídeo em loop (formato GIF) com a legenda
                ...
                console.log(`[DIA ${diffDias}] GIF, texto e sondagem enviados com sucesso!`);
            } else {
                await sock.sendMessage(GRUPO_ID, { text: `Faltam ${diffDias} dias para as férias! 🍻` });
            }

        } else if (diffDias === 0) {
            const bufferFinal = await baixarBuffer("https://media3.giphy.com/media/3oKIPnAiaMCws8nOsE/giphy.mp4");
            await sock.sendMessage(GRUPO_ID, { 
                video: bufferFinal, 
                gifPlayback: true,
