...
const GRUPO_ID = "120363409117435302@g.us"; // ID correto do grupo "Gerês 2k26" obtido nos logs

// --- CONTEÚDO DIÁRIO (Texto formatado e Sondagens - Sem dependência de GIFs externos que quebram) ---
    ...
    try {
        ...
        if (diffDias > 0) {
            if (conteudoDiario[diffDias]) {
                ...
                console.log(`[DIA ${diffDias}] Texto e sondagem enviados com sucesso para o Gerês 2k26!`);
            } else {
